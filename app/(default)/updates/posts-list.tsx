    ...
    <div className="md:grow -my-5 space-y-4">
      {filteredPosts.map((post) => {
        return (
          <article
            key={post.id}
            className="relative pl-12 pr-4 sm:pl-28 py-5 group before:absolute before:left-8 sm:before:left-24 before:right-0 before:inset-y-0 before:bg-linear-to-tr before:from-white/70 before:to-white/50 dark:before:bg-linear-to-b dark:before:from-gray-700/50 dark:before:to-gray-700/40 before:rounded-lg before:shadow-sm before:shadow-black/5 before:-z-10 even:before:opacity-50"
          >
